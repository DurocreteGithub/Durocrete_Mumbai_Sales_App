...
import com.durocrete_mumbai_sales_app.adapter.SiteallocationAdapter;
import com.durocrete_mumbai_sales_app.fragments.GPSTracker;
...
public class Siteallocationactivity extends AppCompatActivity {
    ...
    ArrayList<com.durocrete_mumbai_sales_app.model.Siteallocation> siteallocationArrayList;
...
//        }
        ...
        AddnewSite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Siteallocationactivity.this, com.durocrete_mumbai_sales_app.activity.AddnewSite.class);
...
/*
    ...
    private void makeRouteRequest() {
        ...
        CallWebservice.getWebservice(true, Siteallocationactivity.this, Request.Method.POST, IUrls.Site_allocation, hashMap, new VolleyResponseListener<com.durocrete_mumbai_sales_app.model.Siteallocation>() {
            @Override
            public void onResponse(com.durocrete_mumbai_sales_app.model.Siteallocation[] object, String message, String key) {

                if (object[0] instanceof com.durocrete_mumbai_sales_app.model.Siteallocation) {
                    for (com.durocrete_mumbai_sales_app.model.Siteallocation siteslist : object) {
        ...
        }, com.durocrete_mumbai_sales_app.model.Siteallocation[].class);
